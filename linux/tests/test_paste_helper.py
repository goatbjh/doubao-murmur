...
from doubao_murmur.paste.paste_helper import PasteHelper, UinputPaster


@pytest.fixture(autouse=True)
def disable_uinput(monkeypatch):
    """Exercise command fallbacks independently of host /dev/uinput access."""
